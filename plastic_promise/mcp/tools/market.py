    ...
    try:
        ...
        for entry in remote_entries:
            ...
            if installed:
                ...
                entry["upgradable"] = local.version < entry.get("version", "0.0.0")
            merged.append(entry)
        ...
        return [
            TextContent(
                type="text",
                text=json.dumps(
                    {"error": str(e), "tool": "market_list"}, ensure_ascii=False
                ),
            )
        ]
    ...
    try:
        ...
        return [
            TextContent(
                type="text",
                text=json.dumps(
                    {"error": str(e), "tool": "market_install"}, ensure_ascii=False
                ),
            )
        ]
...
async def handle_market_upgrade(engine: Any, args: dict) -> list[TextContent]:
    ...
    try:
        ...
        if local and local.version >= target.get("version", "0.0.0"):
            return [
                TextContent(
                    type="text",
                    text=json.dumps(
        ...
        return [
            TextContent(
                type="text",
                text=json.dumps(
                    {"error": str(e), "tool": "market_upgrade"}, ensure_ascii=False
                ),
            )
        ]
    ...
    try:
        ...
        return [
            TextContent(
                type="text",
                text=json.dumps(
                    {"error": f"Pack '{name}' not installed"}, ensure_ascii=False
                ),
            )
        ]
    except Exception as e:
        return [
            TextContent(
                type="text",
                text=json.dumps(
                    {"error": str(e), "tool": "market_remove"}, ensure_ascii=False
                ),
            )
        ]
    ...
    try:
        ...
        return [
            TextContent(
                type="text",
                text=json.dumps(
                    {"enabled": name, "success": ok}, ensure_ascii=False
                ),
            )
        ]
    except Exception as e:
        return [
            TextContent(
                type="text",
                text=json.dumps(
                    {"error": str(e), "tool": "market_enable"}, ensure_ascii=False
                ),
            )
        ]
    ...
    try:
        ...
        return [
            TextContent(
                type="text",
                text=json.dumps(
                    {"disabled": name, "success": ok}, ensure_ascii=False
                ),
            )
        ]
    except Exception as e:
        return [
            TextContent(
                type="text",
                text=json.dumps(
                    {"error": str(e), "tool": "market_disable"}, ensure_ascii=False
                ),
            )
        ]
    ...
    try:
        ...
        return [
            TextContent(
                type="text",
                text=json.dumps(
                    {"error": str(e), "tool": "market_status"}, ensure_ascii=False
                ),
            )
        ]

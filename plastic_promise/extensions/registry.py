...
class PackRegistry:
    ...
    REMOTE_INDEX_URL = (
        "https://raw.githubusercontent.com/plastic-promise/"
        "market-index/main/market-index.yml"
    )
